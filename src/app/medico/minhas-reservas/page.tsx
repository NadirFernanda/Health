                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">📍 {r.sala.zona}</p>
                  ...
                  <div className="border-t border-gray-100 px-4 py-4 space-y-4">
                    <div className="flex gap-4 items-start">
                      ...
                      <div className="text-xs text-gray-600 space-y-1">
                        <p>📋 Código: <strong className="font-mono">{r.codigoReserva}</strong></p>
                        <p>💳 {r.metodoPagamento === "MULTICAIXA_EXPRESS" ? "Multicaixa Express" : "Transferência Bancária"}</p>
                        <p>⏱ Duração: {r.duracaoHoras}h</p>
                        <p>💰 Total: {formatAOA(r.valorTotal)}</p>
