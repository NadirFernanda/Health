    ...
    <div>
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-4">
          ...
          <p className="text-sm text-gray-500 mt-0.5">📍 {plantao.clinica.morada}, {plantao.clinica.cidade}</p>
          <p className="text-sm text-gray-500 mt-0.5">🗓 {formatData(plantao.dataInicio)}</p>
          <p className="text-sm text-gray-500 mt-0.5">💰 {plantao.valorKwanzas.toLocaleString()} AOA</p>
        </div>
