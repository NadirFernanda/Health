  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="bg-gradient-to-br from-[#1A6FBB] to-[#0D4F8A] px-6 pt-16 pb-12 flex flex-col items-center text-center">
        ...
        <p className="text-blue-100 mt-2 text-sm font-medium">O teu próximo turno está aqui.</p>
        <p className="text-blue-200 mt-4 text-sm leading-6 max-w-xs">
          Conectamos profissionais de saúde verificados a clínicas em Luanda. Rápido, seguro e com pagamento garantido.
        </p>
      </div>
      ...
      <div className="flex-1 px-6 py-8 flex flex-col gap-4">
        ...
        <div className="mt-4 space-y-3">
          {[
            { icon: "✅", title: "Profissionais verificados", desc: "Credenciais validadas via SINOME/OMA antes de cada turno" },
