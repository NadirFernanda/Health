  ...
  return (
    <div className="flex flex-col items-center justify-center py-14 px-6 text-center">
      <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-4">
        <Icon size={28} strokeWidth={1.5} className="text-[#1A6FBB]" />
      </div>
      ...
      {actionLabel && (actionHref || onAction) && (
        actionHref ? (
          <a
            href={actionHref}
            className="mt-5 inline-flex items-center gap-1.5 bg-[#1A6FBB] text-white text-sm font-semibold px-5 py-2.5 rounded-xl"
          >
            {actionLabel}
          </a>
        ) : (
