...
async function main() {
  ...
  await prisma.transacaoCarteira.createMany({
    data: [
      { profissionalId: medico.id, tipo: "CREDITO", valorCentavos: BigInt(15000), descricao: "Plantão — Clínica Horizonte", estado: "PROCESSADO" },
      { profissionalId: medico.id, tipo: "CREDITO", valorCentavos: BigInt(20000), descricao: "Plantão noturno — Clínica Saúde+", estado: "PROCESSADO" },
      { profissionalId: medico.id, tipo: "DEBITO",  valorCentavos: BigInt(10000), descricao: "Levantamento — Multicaixa Express", estado: "PROCESSADO" },
      { profissionalId: medico.id, tipo: "CREDITO", valorCentavos: BigInt(15000), descricao: "Plantão — Clínica Central", estado: "PROCESSADO" },
      { profissionalId: medico.id, tipo: "CREDITO", valorCentavos: BigInt(15000), descricao: "Plantão — Clínica Horizonte (em processamento)", estado: "PENDENTE" },
    ],
  });
